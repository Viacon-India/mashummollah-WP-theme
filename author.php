	...
	<div class="row">
		<div class="col-md-8 blog-card">
			<header class="page-header">
				<?php
				$get_author_gravatar = get_avatar_url(get_the_author_ID(), array('size' => 50)); ?>
				<img src="<?php echo $get_author_gravatar; ?>" srcset="" alt="<?php the_author(); ?>-avatar" style="margin-right: 10px; float: left;">
				
				<?php 
					the_archive_title( '<h1 class="page-title" style="font-size: 1.5rem;">', '</h1>' );
