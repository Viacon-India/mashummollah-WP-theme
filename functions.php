...
if (!function_exists('dbm_setup')) {
    function dbm_setup()
    {
        ...
        register_nav_menus(array(
            ...
            'secondary_menu' => __('Site Info', 'blog'),
            'companies_menu' => __('My Companies', 'blog'),
            //'links' => __( 'Important Links', 'blog' ),
        ));
...
add_action('widgets_init', 'impackd_widgets_init');
if (!function_exists('impackd_widgets_init')) {
    function impackd_widgets_init()
    {
